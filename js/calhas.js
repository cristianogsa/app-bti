...
function calcDose(){
	var concentracao;
	var carreamento;
	var vaz = calhaVaz;//valor pré-definido function calcVal
    ...
    const vazao = $(".vazaoSp").innerHTML = calhaVaz;
	const con =  $(".conSp").innerHTML = concentracao;
	const car =  $(".carSp").innerHTML = carreamento;
	const dose =  $(".doseSp").innerHTML = Math.round(calhaVaz * concentracao); 
